...
// node_modules/.pnpm/@clawnify+routes@0.2.1_@hono+zod-openapi@0.18.4_hono@4.12.10_zod@3.25.76__hono@4.12.10/node_modules/@clawnify/routes/dist/index.js
...
// node_modules/.pnpm/@clawnify+db@0.4.1/node_modules/@clawnify/db/dist/index.js
var _impl = null;
function initDB(arg) {
...
// node_modules/.pnpm/@clawnify+app@0.1.0_@hono+zod-openapi@0.18.4_hono@4.12.10_zod@3.25.76__hono@4.12.10/node_modules/@clawnify/app/dist/index.js
...
async function putUpload(filename, data, contentType) {
  store.set(filename, { data, contentType });
...
// src/server/index.ts
var app = createApp({ title: "Design App API", version: "1.0.0" });
...
app.openapi(createDesign, async (c) => {
  ...
  const row = await get("SELECT * FROM designs ORDER BY created_at DESC LIMIT 1");
  return c.json(row, 200);
});
...
// .wrangler/tmp/bundle-pdGIga/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-pdGIga/middleware-loader.entry.ts
